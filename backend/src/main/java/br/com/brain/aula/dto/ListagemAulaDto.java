...
public record ListagemAulaDto(Long id, String unidade, String serie, Long turmaId, String turma, String disciplina,
        String professor, String diaDaSemana, String sala, String horarioInicio, String horarioFim) {
